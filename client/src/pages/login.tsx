      ...
      <div className="bg-white shadow p-8 rounded-lg w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-4">
          <svg
            ...
            className="lucide lucide-clock h-8 w-8 text-orange-600"
          >
            <circle cx="12" cy="12" r="10" />
            <polyline points="12 6 12 12 16 14" />
          </svg>

          <h1 className="text-2xl font-bold text-center mt-2 text-orange-600">
            System TimeFlow
          </h1>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full border px-3 py-2 rounded focus:ring-2 focus:ring-orange-500 focus:outline-none"
