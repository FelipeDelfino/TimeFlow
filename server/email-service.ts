...
export class EmailService {
  ...
  async sendWelcomeEmail(userEmail: string, username: string, temporaryPassword: string): Promise<boolean> {
    const subject = 'Bem-vindo ao System TimeFlow - Suas credenciais de acesso';

    const text = `
Olá!

Você foi convidado para usar o sistema System TimeFlow de controle de tempo e tarefas.
...
Atenciosamente,
Equipe System TimeFlow
    `;

    const html = `
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  <h2 style="color: #3B82F6;">Bem-vindo ao System TimeFlow</h2>
  
  <p>Olá!</p>
  
  <p>Você foi convidado para usar o sistema <strong>System TimeFlow</strong> de controle de tempo e tarefas.</p>
  ...
  <p style="color: #6c757d; font-size: 14px;">
    Atenciosamente,<br>
    <strong>Equipe System TimeFlow</strong>
  </p>
</div>
    `;
  ...
  async sendPasswordResetEmail(userEmail: string, username: string, resetToken: string): Promise<boolean> {
    ...
    const subject = 'System TimeFlow - Redefinição de senha';

    const text = `
Olá ${username}!

Você solicitou a redefinição de sua senha no sistema System TimeFlow.
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  ...
  <p>Você solicitou a redefinição de sua senha no sistema <strong>System TimeFlow</strong>.</p>
